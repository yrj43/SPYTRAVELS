...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Welcome to Spytravels admin panel ",
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Weather Forcast Webscrapping" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 5,
                image: "https://tilind.com/wp-content/uploads/2022/03/The-Mansion-House-Brandy-festive-Pack-1.jpg",
                label: "Beverages",
                name: "Drinks"
            }, {
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "The best Gift vouchers for tickets",
                id: 1,
                image: "https://lifafabazar.com/wp-content/uploads/2021/06/Cleartrip-Gift-Vaucher.jpg",
                title: "Clear Trip"
            }, {
                desc: "The best cash discount",
                id: 2,
                image: "https://gos3.ibcdn.com/phonepe-1548000919.jpg",
                title: "Go Bibo"
            }, {
                desc: "The best season offers",
                id: 3,
                image: "https://www.ixigo.com/ixi-api/resize?h=530&w=1000&i=https://www.ixigo.com/offers/content/images/2018/03/offer--1--1.png",
                title: "Ixigo"
            }, {
                desc: "Special domestic offers",
                id: 4,
                image: "https://cdn.grabon.in/gograbon/images/merchant/1616818009622.jpg",
                title: "Make my trip"
            }].map((restaurant) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "All offers at one place" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "./mongodb", target: "_blank" },
